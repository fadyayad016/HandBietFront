...
import { faBell, faFilter, faHeart, faLocationDot, faLock, faUser } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="w-full md:w-4/5 bg-gray-100 p-4 pb-20">
                    <div className="flex justify-between items-center mb-4">
                        <div>
                            ...
                            <p className="text-gray-400">الوجبات والطهاه الذين حفظتهم في قائمة المفضلة</p>
                        </div>
                    ...
                    <div className="relative rounded-xl border border-gray-200 p-2 shadow hover:shadow-lg transition">
                            ...
                            <img src={mealImg} alt="nmm" className="rounded-lg h-40 w-full object-cover" />
