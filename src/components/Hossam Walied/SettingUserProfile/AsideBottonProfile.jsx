...
import { faCartShopping, faGear, faHeart, faHouse } from "@fortawesome/free-solid-svg-icons";
...
export default function AsideBottonProfile() {
    ...
    return (
      <div className="bg-amber-300 py-4 w-full fixed bottom-0 left-0 md:hidden flex justify-between items-center px-6 z-50" dir="rtl">
