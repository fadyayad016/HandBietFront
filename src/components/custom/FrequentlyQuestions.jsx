  ...
  return (
    <div className="w-full text-center mt-12">
      ...
      <div className="mb-6">
        ...
        <p className="text-[#4B5563] text-sm">
          أنت من يحدد سعر وجباتك بناءً على تكلفة المكونات والوقت والجهد المبذول. سنقدم لك نصائح لتسعير وجباتك بشكل
      ...
      <div className="mb-6">
        ...
        <p className="text-[#4B5563] text-sm">
          يتم تحويل الأرباح إلى حسابك البنكي بشكل أسبوعي بعد خصم رسوم الخدمة البسيطة. يمكنك تتبع جميع عمليات البيع
      ...
      <div className="mb-6">
        ...
        <p className="text-[#4B5563] text-sm">
          لا يوجد حد أقصى! يمكنك بيع أي عدد من الوجبات حسب قدرتك. ننصحك بالبدء بعدد معقول ثم زيادته تدريجيًا مع نمو قاعدة
          عملائك
        </p>
      </div>
    </div>
