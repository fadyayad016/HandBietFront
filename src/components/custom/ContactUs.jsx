...
import { faTwitter, faInstagram, faSnapchat, faTiktok } from "@fortawesome/free-brands-svg-icons"; 
...
{/* Contact Our Team */}
      <div className="w-full text-center bg-[#FFEDD5] py-6 px-8 rounded-lg">
        ...
        <p className="text-[#4B5563] text-sm">
          نحن هنا لمساعدتك! سواء كان لديك استفسار، اقتراح أو أي سؤال، فريقنا سعيد بالتواصل معك
        </p>
      </div>
...
<div className="container mx-auto mt-6 mb-4 px-4 flex flex-col items-center gap-6 lg:flex-row" dir="rtl">
        <div className="w-full border p-6 rounded-2xl bg-white">
          <h3 className="font-bold text-2xl text-[#1F2937] mb-6">أرسل رسالتك</h3>
          <form action="">
...
{/*Contact Information  */}
        ...
        <div className="w-full p-6 border rounded-2xl bg-white">
          <h3 className="font-bold text-2xl text-[#1F2937] mb-4">معلومات التواصل</h3>
          <p className="mb-6 text-[#4B5563]">
            نرحب بتواصلك معنا في أي وقت. فريق الدعم لدينا متاح على مدار الساعة للاجابة على استفساراتك ومساعدتك في أي مشكلة تواجهك.
          </p>
          <form>
            <div className="flex items-center gap-4 my-4 bg-[#FFEDD5] p-4 rounded-lg">
              <FontAwesomeIcon className="text-amber-600 p-4 rounded-4xl bg-[#f974163d]" icon={faPhoneFlip} />
              <div>
                <h4 className="font-bold text-[#1F2937]">اتصل بنا</h4>
                <p className="text-[#4B5563]">0123456789</p>
                <p className="text-[#4B5563]">من الاحد الي الخميس - 8 صباحا -5 مساء</p>
              </div>
            </div>
            <div className="flex items-center gap-4 my-4 bg-[#FFEDD5] p-4 rounded-lg">
              <FontAwesomeIcon className="text-amber-600 p-4 rounded-4xl bg-[#f974163d]" icon={faEnvelope} />
              <div>
            ...
            <div className="flex items-center gap-4 my-4 bg-[#FFEDD5] p-4 rounded-lg">
              <FontAwesomeIcon className="text-amber-600 p-4 rounded-4xl bg-[#f974163d]" icon={faLocationDot} />
              <div>
              <h4 className="font-bold text-[#1F2937]"> العنوان </h4>
              <p className="text-[#4B5563]">الرياض - المملكة العربية السعودية</p>
              <p className="text-[#4B5563]">المكتب الرئيسي: شارع الملك فهد، برج النخيل</p>
                            </div>
            </div>
            <p className="font-bold text-[#1F2937] mb-6">تابعنا على وسائل التواصل</p>
            <div>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="mx-2 bg-[#F9F9F9] rounded-3xl p-3">
                <FontAwesomeIcon icon={faTwitter} />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="mx-2 bg-[#F9F9F9] rounded-3xl p-3">
                <FontAwesomeIcon icon={faInstagram} />
              </a>
              <a href="https://snapchat.com" target="_blank" rel="noopener noreferrer" className="mx-2 bg-[#F9F9F9] rounded-3xl p-3">
                <FontAwesomeIcon icon={faSnapchat} />
              </a>
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="mx-2 bg-[#F9F9F9] rounded-3xl p-3">
