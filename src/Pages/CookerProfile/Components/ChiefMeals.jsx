...
const ChiefMeals = () => {
  return (
    <div  className=" my-9">
      <h4 className=" my-4">وجبات الطاهي </h4>
      ...
      <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        {/* {[...Array(3)].map((_, index) => ( */}
          ...
          <a href="#" class="relative ">
            ...
            {/* badge */}
            <span class="absolute top-4 right-5 bg-[#eab308] text-white text-xs font-medium me-2 px-2.5 py-0.5 rounded-full  inline-flex items-center">الاكثر طلبا
        ...
        <div className="w-full max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <a href="#" class="relative ">
            ...
            <span class="absolute top-4 right-5 bg-mainColor text-white text-xs font-medium me-6 px-2.5 py-0.5 rounded-full  inline-flex items-center">مميز
              <svg className="w-4 h-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <div className="w-full max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <a href="#" class="relative ">
            ...
            <span class="absolute top-4 right-5 bg-[#22c55e] text-white text-xs font-medium me-25 px-2.5 py-0.5 rounded-full  inline-flex items-center">صحي
              <svg className="w-4 h-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <div className="flex items-center justify-center mt-8">
        <a href="#" className="text-mainColor border border-mainColor hover:text-hoverColor hover:border-hoverColor focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  "> عرض المزيد من المنتجات ←</a>
      </div>
    </div>
  )
}

export default ChiefMeals