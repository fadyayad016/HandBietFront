            ...
            <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
                <div class="mx-auto">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl flex inline-flex">
                        <svg className="w-8 h-8 text-mainColor dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                        <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                            ...
                                            <a href="#" class="shrink-0 md:order-1">
                                                <img class="h-30 w-40 dark:hidden rounded-lg" src={"../../public/ProductDetailesImages/detailesImage1.png"} alt="imac image" />
                                            </a>
                                            ...
                                            <div class="flex items-center justify-between md:order-3 md:justify-end my-3">
                                                ...
                                                <div class="text-end md:order-4 md:w-32">
                                                    <p class="text-base font-bold text-gray-900 dark:text-white">1,499  رس</p>
                                                </div>
                                            </div>

                                            <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">باستا كريمية مع صلصة الجبن الأبيض</a>

                                                <div class="flex items-center gap-4">
                                                    <button type="button" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 hover:underline dark:text-gray-400 dark:hover:text-white">
                                                        <svg class="me-1.5 h-5 w-5 hover:text-red-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <div class="mx-auto mt-6 max-w-2xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                            <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                                <p class="text-xl font-semibold text-gray-900 dark:text-white flex inline-flex">
                                    <svg class="w-6 h-6 text-mainColor dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="space-y-4">
                                    <div class="space-y-2">
                                        <dl class="flex items-center justify-between gap-4">
                                            <dt class="text-base font-normal text-gray-500 dark:text-gray-400">السعر الاساسي</dt>
                                            <dd class="text-base font-medium text-gray-900 dark:text-white">7,592.00  رس</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4">
                                            <dt class="text-base font-normal text-gray-500 dark:text-gray-400">خصم</dt>
                                            <dd class="text-red-500 font-medium text-green-600">-299.00  رس</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4">
                                            <dt class="text-base font-normal text-gray-500 dark:text-gray-400">رسوم التوصيل</dt>
                                            <dd class="text-base font-medium text-gray-900 dark:text-white">99   رس</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4">
                                            <dt class="text-base font-normal text-gray-500 dark:text-gray-400">ضريبه</dt>
                                            <dd class="text-base font-medium text-gray-900 dark:text-white">799  رس</dd>
                                        </dl>
                                    </div>

                                    <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                        <dt class="text-base font-bold text-gray-900 dark:text-white">المجموع</dt>
                                        <dd class="text-green-500 font-bold text-gray-900 dark:text-white">8,191.00  رس</dd>
                                    </dl>
                                </div>

                                <a href="#" class="flex w-full items-center justify-center rounded-lg bg-mainColor hover:bg-hoverColor 
                                                    px-5 py-2.5 text-sm font-medium text-white 
                                                    focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600
                                                     bg-mainColor hover:bg-hoverColor dark:focus:ring-primary-800">متابعه  الي  الدفع ←</a>

                                <div class="flex items-center justify-center gap-2">
                                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400"> او </span>
                                    <a href="#" title="" class="inline-flex items-center gap-2 text-sm font-medium text-primary-500 no-underline hover:underline dark:text-primary-500">
                                        استمر في التسوق
                                        ←
                                    </a>
                                </div>
                            ...
                            <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                                <form class="space-y-4">
                                    <div >
                                        <label for="voucher" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white flex inline-flex">
                                            <svg class="w-6 h-6 text-mainColor dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <input type="text" id="voucher" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="ادخل كود الخصم" />
                                    </div>
                                    <button type="submit" class="flex w-full items-center justify-center rounded-lg bg-mainColor hover:bg-hoverColor px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">تطبيق </button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class=" grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                    ...
                    <div class="space-y-4 overflow-hidden rounded-lg border border-gray-200 bg-white p-2  dark:border-gray-700 dark:bg-gray-800">
                        <a href="#" class="overflow-hidden rounded">
                            <img class="mx-auto h-40 w-150 " src={"../../public/برجر.png"} alt="imac image" />
                        </a>
                        <div className='mt-2'>
                            <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">بيتزا خضار</a>
                            <p class="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">بيتزا غنية بالبروتين والخضروات الطازجة</p>
                        </div>
                        <div>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">
                                <span class="text-lg font-bold leading-tight text-mainColor dark:text-red-500">299  رس</span>

                                <span class="line-through mx-3 text-red-600"> 399,99  </span>
                            </p>
                        ...
                        <div class="mt-6 flex items-center gap-2.5">
                            <button data-tooltip-target="favourites-tooltip-1" type="button" class="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
                                <svg class="h-5 w-5 hover:text-red-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            ...
                            <button type="button" class="inline-flex w-full items-center justify-center rounded-lg  px-5 py-2.5 text-sm font-medium  text-white bg-mainColor hover:bg-hoverColor focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    ...
                    <div class="space-y-4 overflow-hidden rounded-lg border border-gray-200 bg-white p-2  dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="mt-6 flex items-center gap-2.5">
                            ...
                            <button type="button" class="inline-flex w-full items-center justify-center rounded-lg bg-mainColor px-5 py-2.5 text-sm font-medium  text-white hover:bg-hoverColor focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                <svg class="-ms-2 me-2 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 4h1.5L9 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-8.5-3h9.25L19 7h-1M8 7h-.688M13 5v4m-2-2h4" />
                                </svg>
                                Add to cart
