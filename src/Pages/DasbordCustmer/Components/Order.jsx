      ...
      <div className="bg-white p-4 rounded-xl shadow-md my-4 flex justify-between">
        <div className="flex">
          <div className="relative">
            ...
            <span className="absolute -top-1 -right-5 px-2 py-1 text-sm bg-green-200 text-green-600 rounded-xl shadow">
              تم التوصيل
            </span>
          </div>
          ...
          {orderCase === "done" && (
            <div className="mt-2">
              <button className="bg-gray-100 p-2 rounded-xl">
                <FontAwesomeIcon icon={faRotateRight} /> اعادة الطلب
              </button>
              <button className="bg-gray-100 p-2 ms-4 rounded-xl">
                <FontAwesomeIcon icon={faCommentDots} /> تقييم
              </button>
            </div>
          )}
          {orderCase === "waiting" && (
            <div className="mt-2">
              <button className="bg-gray-100 p-2 rounded-xl">
                <FontAwesomeIcon icon={faClock} /> قيد التجهيز
              </button>
              <button className="bg-gray-100 p-2 ms-4 rounded-xl">
                <FontAwesomeIcon icon={faPhone} /> اتصال بالطاهي
              </button>
            </div>
          )}
          {orderCase === "inWay" && (
            <div className="mt-2">
              <button className="bg-gray-100 p-2 rounded-xl">
                <FontAwesomeIcon icon={faCarSide} /> تتبع الطلب
              </button>
              <button className="bg-gray-100 p-2 ms-4 rounded-xl">
                <FontAwesomeIcon icon={faPhone} /> اتصال بالسائق
              </button>
            </div>
          )}
        </div>
