...
export function PaginationComponent() {
  ...
  return (
    <div className="flex overflow-x-auto sm:justify-center">
      <Pagination
        dir="rtl"
        className="flex overflow-x-auto mb-5 sm:justify-center"
        ...
        theme={{
          ...
          pages: {
            ...
            selector: {
              ...
              active:
                "bg-orange-50 text-orange-600 hover:bg-cyan-100 hover:text-cyan-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white",
