  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center bg-[#FFEDD5] py-15 px-5">
        <h2 className="font-bold text-[#1F2937] text-4xl mb-4">
          الأسئلة الشائعة
        </h2>
        <p className="text-xl text-[#757575] text-center">
          لديك استفسار؟ ربما وجدنا لك الاجابة هنا. تصفح الاسئلة الشائعة او ابحث
          عن سؤالك المحدد
        </p>
      </div>
      ...
      <div className="container mx-auto" dir="rtl">
        <div className="w-full flex items-start justify-start bg-[#F9F9F9] py-5 px-5">
          <aside className="w-1/3 py-5 px-5 bg-white rounded-2xl">
            <h3 className="font-bold text-[#1F2937] text-2xl">
              تصفح حسب الفئة
            </h3>
            <br />
            <ul>
              ...
              >
                <a href="#settings">
                  <FontAwesomeIcon className="me-3" icon={faIdCard} /> الحساب
                  والاعدادات
                </a>
              </li>
              <li
          ...
          <div className="w-2/3 py-5 px-5">
            {/* الطلب والتوصيل */}
            <h3 className="font-bold text-[#1F2937] text-2xl mb-4">
              الطلب والتوصيل
            </h3>
            <div className="space-y-4">
              {[
                {
                  question: "كيف يمكنني تقديم طلب على HandBiet؟",
                  answer: "يمكنك تقديم طلب من خلال التطبيق أو الموقع.",
                },
                {
                  question: "ما هي مناطق التوصيل المتاحة؟",
                  answer: "نقوم بالتوصيل إلى جميع المناطق الرئيسية.",
                },
                {
                  question: "كم تستغرق عملية التوصيل؟",
                  answer: "عادةً ما تستغرق عملية التوصيل من 30 إلى 60 دقيقة.",
                },
                {
                  question: "هل يمكنني تعديل طلبي بعد تقديمه؟",
                  answer: "نعم، يمكنك تعديل الطلب قبل بدء التحضير.",
                },
              ].map((item, index) => (
                <div
                  key={index}
            ...
            {/* الدفع والفوترة */}
            <h3 className="font-bold text-[#1F2937] text-2xl mt-8 mb-4">
              الدفع والفوترة
            </h3>
            <div className="space-y-4">
              {[
                {
                  ...
                  answer: "نقبل الدفع نقدًا أو عبر البطاقات الائتمانية.",
                },
                {
                  question: "هل توجد رسوم إضافية على الطلبات؟",
                  answer: "لا توجد رسوم إضافية على الطلبات.",
                },
                {
                  question: "كيف يمكنني الحصول على فاتورة ضريبية؟",
                  answer: "يمكنك طلب الفاتورة من خلال التطبيق.",
                },
              ].map((item, index) => (
                <div
                  key={index + 4}
            ...
            <div className="space-y-4">
              {[
                {
                  question: "كيف يمكنني الانضمام كطاهٍ في HandBiet؟",
                  answer:
                    "يمكنك التسجيل عبر الموقع الرسمي واتباع الخطوات المطلوبة.",
                },
                {
                  question: "كيف يتم تحديد أسعار الوجبات؟",
                  answer:
                    "يتم تحديد الأسعار بناءً على المكونات وتكاليف التحضير.",
                },
                {
                  question: "كيف ومتى أحصل على مستحقاتي المالية؟",
                  answer:
                    "يتم تحويل المستحقات المالية بشكل دوري إلى حسابك البنكي.",
                },
              ].map((item, index) => (
                <div
                  key={index + 8}
              ...
              {[
                {
                  ...
                  answer:
                    "يمكنك استعادة كلمة المرور من خلال النقر على خيار 'نسيت كلمة المرور' في صفحة تسجيل الدخول.",
                },
                {
                  question: "كيف يمكنني تحديث معلومات حسابي؟",
                  answer:
                    "يمكنك تحديث معلومات حسابك من خلال صفحة الإعدادات في التطبيق.",
                },
                {
                  question: "كيف يمكنني حذف حسابي؟",
                  answer:
                    "يمكنك طلب حذف الحساب من خلال التواصل مع فريق الدعم الفني.",
                },
              ].map((item, index) => (
                <div
                  key={index + 11}
            ...
            <div className="space-y-4">
              {[
                {
                  question: "ما هي إجراءات السلامة المتبعة لضمان جودة الوجبات؟",
                  answer:
                    "نلتزم بأعلى معايير الجودة والسلامة لضمان تقديم وجبات آمنة وصحية.",
                },
                {
                  question: "ماذا أفعل إذا لم تكن الوجبة كما هو متوقع؟",
                  answer:
                    "يمكنك التواصل مع فريق الدعم الفني لحل المشكلة واسترداد المبلغ إذا لزم الأمر.",
                },
                {
                  question: "كيف يتم التعامل مع الحساسية الغذائية؟",
                  answer:
                    "نحرص على توفير معلومات واضحة عن المكونات لتجنب أي حساسية غذائية.",
                },
              ].map((item, index) => (
                <div
                  key={index + 14}
      ...
      <div className="w-full flex flex-col items-center justify-center bg-[#FFEDD5] py-15 px-5">
        <h2 className="font-bold text-[#1F2937] text-2xl mb-4">
          {" "}
          لا زلت لديك أسئلة؟
        </h2>
        <p className="text-xl text-[#757575] text-center">
          فريق الدعم لدينا متاح على مدار الساعة للإجابة على جميع استفساراتك
          ومساعدتك في أي مشكلة تواجهك
        </p>
        <a
          href="/ContactUs"
