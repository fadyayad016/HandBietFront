...
import CommonQuesAlert from "../../components/CommonQuesAlert";
...
const ContactUsPage = () => {
  ...
  const content =
    "نحن هنا لمساعدتك سواء كان لديك استفسار حول طلبك الحالي، أو تحتاج إلى مساعدة في استخدام التطبيق، أو لديك اقتراحات لتحسين خدماتنا. فريق الدعم لدينا متاح على مدار الساعة للرد على استفساراتك ومساعدتك في أي مشكلة قد تواجهها. لا تتردد في التواصل معنا عبر القنوات المتاحة أدناه.";
  return (
    <div className=" bg-[#F9F9F9]">
      ...
      >
        <div className="w-full border p-6 rounded-2xl bg-white">
          ...
          <form action="">
            <div className="flex gap-4 mb-6 ">
              <div className=" w-1/2 ">
                ...
                <div className="relative">
                  ...
                  />
                  <FontAwesomeIcon
                    className="absolute top-1/2 start-2 transform -translate-y-1/2 text-gray-400"
                    icon={faUser}
                  />
                </div>
              </div>
            ...
            <div className="mt-10 w-full">
              <button className="w-full btn bg-amber-500 text-white py-4 rounded-2xl">
                ارسال الرسالة
        ...
        <div className="w-full p-6 rounded-2xl bg-white">
          ...
          <p className="mb-6">
            نرحب بتواصلك معنا في اي وقتز فريق الدعم لدينا متاح على مدار الساعة
            للرد على استفساراتك ومساعدتك في أي مشكلة قد تواجهها.
          </p>
          <div className="flex items-center gap-4 my-4 bg-amber-200 p-4 rounded-lg">
            <FontAwesomeIcon
              className="text-amber-600 p-4 rounded-4xl bg-amber-400 "
              icon={faPhoneFlip}
            />
            <div>
          ...
          <div className="flex items-center gap-4 my-4 bg-amber-200 p-4 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-800">
                المكتب الرئيسي: شارع الملك فهد برج النخيل
              </p>
            </div>
          </div>
          <p className="font-bold mb-6">تابعنا علي وسائل التواصل</p>
          <div>
            <a href="#" className="mx-2 bg-[#F9F9F9] rounded-3xl p-3">
