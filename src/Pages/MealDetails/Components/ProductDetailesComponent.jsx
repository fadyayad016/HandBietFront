      ...
      <div className="grid grid-cols-1 py-2 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 my-5 mx-10">
        ...
        <div className="w-auto bg-white border border-gray-200 rounded-lg shadow-sm col-span-2 ">
          <img
            ...
            src={"/public/ProductDetailesImages/detailesImage1.png"}
            alt=""
          />
            ...
            <tr>
              <td>
                <img
                  ...
                  src={"/public/ProductDetailesImages/detailesImage2.png"}
                  alt=""
                />
              </td>
              ...
              <td>
                <img
                  className="h-auto max-w-full rounded-lg"
                  src={"/public/ProductDetailesImages/detailesImage3.png"}
                  alt=""
                />
              </td>
              ...
              <td>
                <img
                  className="h-auto max-w-full rounded-lg"
                  src={"/public/ProductDetailesImages/detailesImage4.png"}
                  alt=""
                />
              </td>
              ...
              <td>
                <img
                  className="h-auto max-w-full rounded-lg"
                  src={"/public/ProductDetailesImages/detailesImage5.png"}
                  alt=""
                />
              </td>
            </tr>
        ...
        <div className=" px-8 py-6 bg-white border border-gray-200 rounded-lg shadow-sm">
          ...
          <div className="flex flex-row justify-between mb-8">
            ...
            <div className="text-orange-500 font-bold text-2xl">
              75 <span className="text-sm">ر.س</span>
            </div>
          </div>
          ...
          <div className="flex justify-end mb-6">
            <p className="text-right text-gray-700">
              كبسة دجاج تقليدية مع أرز بسمتي عالي الجودة وخلطة توابل مميزة من 3
              أشخاص.
            </p>
          </div>
